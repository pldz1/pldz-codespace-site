...
tags: [ROS2基础]
date: 2025-01-01
thumbnail: /api/v1/image/ROS2/2_ros2_basic_communication_thumbnail.jpg
...
![Topic-MultiplePublisherandMultipleSubscriber](/api/v1/image/ROS2/2_Topic-MultiplePublisherandMultipleSubscriber.gif)
...
> ![命名的问题](/api/v1/image/ROS2/2_right_package_name.png)
...
![C/C++订阅和发布基础消息](/api/v1/image/ROS2/2_basic_build_result.png)
...
![创建Python功能包](/api/v1/image/ROS2/2_create_basic_python_package.png)
...
![话题通讯多对多](/api/v1/image/ROS2/2_basic_multi_communication_result.png)
