...
tags: [ROS2基础]
date: 2025-01-01
thumbnail: /api/v1/image/ROS2/2_ros2_custom_topic_communication_thumbnail.png
...
![ROS2功能包命名问题](/api/v1/image/ROS2/2_right_package_name.png)
...
![自定义消息的文件位置](/api/v1/image/ROS2/2_custom_package_path.png)
...
![自定义消息C/C++通讯](/api/v1/image/ROS2/2_custom_cpp_communication.png)
...
![Vscode对自定义节点的Python配置](/api/v1/image/ROS2/2_custom_py_package_path.png)
...
![自定义话题通讯](/api/v1/image/ROS2/2_multi_custom_communication.png)
