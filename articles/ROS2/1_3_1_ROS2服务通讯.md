...
tags: [ROS2基础]
date: 2025-01-01
thumbnail: /api/v1/image/ROS2/2_ros2_basic_service_thumbnail.jpg
...
![一对一的服务通讯](/api/v1/image/ROS2/3_Service-SingleServiceClient.gif)

服务通讯也可以是单个服务端和多个客户端通讯，一对多的模式

![一对多的服务通讯](/api/v1/image/ROS2/3_Service-MultipleServiceClient.gif)
...
![自定义话题通讯的功能包位置](/api/v1/image/ROS2/3_custom_srv_package_path.png)
...
![vscode的C/C++环境配置](/api/v1/image/ROS2/3_srv_cpp_vscode_config.png)
...
![C/C++实现服务通讯](/api/v1/image/ROS2/3_cpp_srv_result.png)
...
![配置vscode的Python环境](/api/v1/image/ROS2/3_srv_py_vscode_config.png)
...
![运行所有节点](/api/v1/image/ROS2/3_py_srv_result.png)
