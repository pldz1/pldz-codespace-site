...
tags: [ROS2基础]
date: 2025-01-01
thumbnail: /images/ROS2/4_ros2_params_thumbnail.jpg
...
![C/C++实现参数服务](/images/ROS2/4_cpp_params_server_result.png)
...
![C/C++实现参数客户端](/images/ROS2/4_cpp_params_client_result.png)
...
![Python运行节点参数](/images/ROS2/4_py_params_result.png)
