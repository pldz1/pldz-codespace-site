  ...
  <div class="main-container">
    ...
    <aside class="sidebar sidebar-sticky" ref="mainSidebarContainerRef">
      <div class="sidebar-card" ref="sidebarContentRef">
        ...
        <div :class="['sidebar-item', { active: activeCategory === '文章管理' }]" @click="onActiveCategory('文章管理')">
          <span class="sidebar-icon">📃 </span>
          文章管理
        </div>
        <div :class="['sidebar-item', { active: activeCategory === '专栏管理' }]" @click="onActiveCategory('专栏管理')">
          <span class="sidebar-icon">📙 </span>
          专栏管理
        </div>
        <div :class="['sidebar-item', { active: activeCategory === '图片管理' }]" @click="onActiveCategory('图片管理')">
          <span class="sidebar-icon">📷</span>
          图片管理
        </div>
        <div :class="['sidebar-item', { active: activeCategory === '缓存管理' }]" @click="onActiveCategory('缓存管理')">
          <span class="sidebar-icon">💾</span>
          缓存管理
        </div>
        <div :class="['sidebar-item', { active: activeCategory === 'CodeSpace管理' }]" @click="onActiveCategory('CodeSpace管理')">
          <span class="sidebar-icon">🎈</span>
          CodeSpace管理
        </div>
        <div :class="['sidebar-item', { active: activeCategory === 'Git插件' }]" @click="onActiveCategory('Git插件')">
          <span class="sidebar-icon">🔁</span>
          Git插件
        </div>
      </div>
    ...
    <main class="content">
      <!-- 中间内容 -->
      <div class="article-list" v-if="activeCategory === '文章管理'">
